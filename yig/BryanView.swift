        ...
        NavigationView{
            ...
            HStack{
                ...
                HStack{
                    ...
                    Text("Hello! My name is Bryan, I am the lead programmer for the Osiris team. I set all servo and motor controls. I also program our robot to move autonomously in competition.")
                    .font(.system(size: 30))
...
struct BryanView_Previews: PreviewProvider {
